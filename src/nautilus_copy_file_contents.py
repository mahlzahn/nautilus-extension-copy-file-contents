...
class CopyFileContents(GObject.GObject, Nautilus.MenuProvider):
    ...
    def get_file_items(self, files):
        ...
        if len(files) == 1:
            ...
            if self.is_text_mime_type(mime_type):
                ...
                menu_item.connect('activate', self.copy_text_content, file_path)
            ...
            if self.is_image_mime_type(mime_type):
                ...
                menu_item.connect('activate', self.copy_image_content, file_path)
                menu_items.append(menu_item)

        return menu_items

    def copy_text_content(self, menu, file_path):
    ...
    def copy_image_content(self, menu, file_path):
